...
public class DeviceListActivity extends Activity {
	...
	private void initNeighborTable(){
		...
		String mac = wm.getConnectionInfo().getMacAddress().toLowerCase();
	...
	private void initWifiUtils(){
		...
		mWifiController.startWifiServer();
	}
	...
	private class WifiP2pPeerListListener implements PeerListListener{
		...
		public void onPeersAvailable(WifiP2pDeviceList peers) {
			...
			if(neighborTableManager != null){
				mWifiController.updateConnectedDeviceList(new ArrayList<WifiP2pDevice>(peers.getDeviceList()));
