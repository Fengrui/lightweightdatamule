...
public class WifiController extends BroadcastReceiver {
	...
	public void updateConnectedDeviceList(ArrayList<WifiP2pDevice> devices){
		ArrayList<String> newConnectedWifiDevices = new ArrayList<String>();
		for(WifiP2pDevice device : devices){
			if(connectedWifiDevices.contains(device.deviceAddress)){
				newConnectedWifiDevices.add(device.deviceAddress);
			}
		}
		connectedWifiDevices = newConnectedWifiDevices;
		Log.d(TAG, "# connected devices " + String.valueOf(connectedWifiDevices.size()));
	}
